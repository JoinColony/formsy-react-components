...
var cleanProps = function cleanProps(props) {
    ...
    var renderErrorMessages = props.renderErrorMessages;
    var validatePristine = props.validatePristine;

    var rest = _objectWithoutProperties(props, ["mapping", "validationErrors", "onSubmit", "onValid", "onValidSubmit", "onInvalid", "onInvalidSubmit", "onChange", "reset", "preventExternalInvalidation", "onSuccess", "onError", "validationError", "validations", "addonAfter", "addonBefore", "addGroupErrors", "buttonAfter", "buttonBefore", "elementOnly", "elementWrapperClassName", "help", "immediateValidation", "isGrouped", "isLoading", "label", "options", "labelClassName", "rowClassName", "rowLabel", "renderErrorMessages", "validatePristine"]);
